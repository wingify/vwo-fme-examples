...
> A simple example web application showcasing VWO Feature Management and Experimentation (PHP SDK) integration, enabling dynamic feature flags and user interaction tracking.
...
6. **Interact with the App:**
    ...
    - You will see that the query response and model name is changed based on the feature flag variation.
        - <img src="../screenshots/server-side/result.png" width="600" alt="VWO FME PHP SDK Example Result">

    - You can also check the settings and SDK logs using the `Show settings` and `Show SDK Logs` buttons.
        - <img src="../screenshots/server-side/settingsAndLogs.png" width="600" alt="VWO FME PHP SDK Example Settings & Logs">
